<template>
  <el-config-provider :locale="locale">
    <div
      class="flex items-center bg-gray-800 dark:bg-gray-800 absolute inset-0 h-full rounded-md overflow-hidden transition-opacity"
      :class="focusFlag ? 'opacity-100' : 'opacity-50'"
    >
      <div class="flex-none h-full">
        <el-button
          type="primary"
          class="!px-3 bg-transparent !border-none !h-full text-white"
          plain
          @click="handleClose"
        >
          <el-icon class="">
      ...
      <div
        class="h-4 w-px mx-1 bg-gray-600 dark:bg-gray-600 flex-none"
      ></div>
      ...
      <div class="flex-none h-full app-region-drag">
        <el-button type="primary" text class="!px-3 !h-full text-white">
          <el-icon class="">
            <ElIconRank />
          </el-icon>
        </el-button>
